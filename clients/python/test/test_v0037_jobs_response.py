...
from openapi_client.models.v0037_jobs_response import V0037JobsResponse  # noqa: E501
    ...
    def make_instance(self, include_optional) -> V0037JobsResponse:
        ...
        if include_optional:
            return V0037JobsResponse(
                ...
                jobs = [
                    openapi_client.models.v0/0/37_job_response_properties.v0.0.37_job_response_properties(
                        account = '', 
                        accrue_time = 56, 
                        admin_comment = '', 
                        array_job_id = '', 
