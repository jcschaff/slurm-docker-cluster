...
from openapi_client.models.v0037_diag_statistics import V0037DiagStatistics  # noqa: E501
...
class TestV0037DiagStatistics(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0037DiagStatistics:
        """Test V0037DiagStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0037DiagStatistics`
        """
        model = V0037DiagStatistics()  # noqa: E501
        if include_optional:
            return V0037DiagStatistics(
                parts_packed = 56,
                req_time = 56,
                req_time_start = 56,
