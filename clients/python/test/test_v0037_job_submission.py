...
from openapi_client.models.v0037_job_submission import V0037JobSubmission  # noqa: E501
...
class TestV0037JobSubmission(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0037JobSubmission:
        ...
        """
        model = V0037JobSubmission()  # noqa: E501
        if include_optional:
            return V0037JobSubmission(
                script = '',
                job = openapi_client.models.v0/0/37_job_properties.v0.0.37_job_properties(
                    account = '', 
                    ...
                    wckey = '', ),
                jobs = [
                    openapi_client.models.v0/0/37_job_properties.v0.0.37_job_properties(
                        account = '', 
                        account_gather_freqency = '', 
                        argv = [
                            ''
