...
class Dbv0037ResponseTres(BaseModel):
    """
    Dbv0037ResponseTres
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseTres:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseTres:
        """Create an instance of Dbv0037ResponseTres from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseTres.parse_obj(obj)

        _obj = Dbv0037ResponseTres.parse_obj({
