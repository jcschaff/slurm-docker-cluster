...
class Dbv0037ResponseAssociations(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseAssociations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseAssociations:
        """Create an instance of Dbv0037ResponseAssociations from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseAssociations.parse_obj(obj)

        _obj = Dbv0037ResponseAssociations.parse_obj({
