...
class Dbv0037ResponseWckeyAdd(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseWckeyAdd:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseWckeyAdd:
        """Create an instance of Dbv0037ResponseWckeyAdd from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseWckeyAdd.parse_obj(obj)

        _obj = Dbv0037ResponseWckeyAdd.parse_obj({
