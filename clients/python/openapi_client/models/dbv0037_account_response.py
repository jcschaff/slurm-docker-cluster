...
class Dbv0037AccountResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037AccountResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037AccountResponse:
        """Create an instance of Dbv0037AccountResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037AccountResponse.parse_obj(obj)

        _obj = Dbv0037AccountResponse.parse_obj({
