...
class Dbv0037ResponseClusterAdd(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseClusterAdd:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseClusterAdd:
        """Create an instance of Dbv0037ResponseClusterAdd from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseClusterAdd.parse_obj(obj)

        _obj = Dbv0037ResponseClusterAdd.parse_obj({
