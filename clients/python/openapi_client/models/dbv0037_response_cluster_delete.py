...
class Dbv0037ResponseClusterDelete(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseClusterDelete:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseClusterDelete:
        """Create an instance of Dbv0037ResponseClusterDelete from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseClusterDelete.parse_obj(obj)

        _obj = Dbv0037ResponseClusterDelete.parse_obj({
