...
class Dbv0037AssociationMaxTresMinutesPer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037AssociationMaxTresMinutesPer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037AssociationMaxTresMinutesPer:
        """Create an instance of Dbv0037AssociationMaxTresMinutesPer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037AssociationMaxTresMinutesPer.parse_obj(obj)

        _obj = Dbv0037AssociationMaxTresMinutesPer.parse_obj({
