...
class Dbv0037AssociationMaxTresPer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037AssociationMaxTresPer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037AssociationMaxTresPer:
        """Create an instance of Dbv0037AssociationMaxTresPer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037AssociationMaxTresPer.parse_obj(obj)

        _obj = Dbv0037AssociationMaxTresPer.parse_obj({
