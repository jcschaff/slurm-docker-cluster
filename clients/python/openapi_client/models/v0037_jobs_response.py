...
class V0037JobsResponse(BaseModel):
    """
    V0037JobsResponse
    """
    errors: Optional[conlist(V0037Error)] = Field(None, description="slurm errors")
    jobs: Optional[conlist(V0037JobResponseProperties)] = Field(None, description="job descriptions")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V0037JobsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V0037JobsResponse:
        """Create an instance of V0037JobsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V0037JobsResponse.parse_obj(obj)

        _obj = V0037JobsResponse.parse_obj({
            "errors": [V0037Error.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "jobs": [V0037JobResponseProperties.from_dict(_item) for _item in obj.get("jobs")] if obj.get("jobs") is not None else None
        })
        return _obj
