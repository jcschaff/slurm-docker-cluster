...
class Dbv0037ConfigResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ConfigResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ConfigResponse:
        """Create an instance of Dbv0037ConfigResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ConfigResponse.parse_obj(obj)

        _obj = Dbv0037ConfigResponse.parse_obj({
