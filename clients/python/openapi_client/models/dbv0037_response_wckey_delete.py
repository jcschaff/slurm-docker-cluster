...
class Dbv0037ResponseWckeyDelete(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseWckeyDelete:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseWckeyDelete:
        """Create an instance of Dbv0037ResponseWckeyDelete from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseWckeyDelete.parse_obj(obj)

        _obj = Dbv0037ResponseWckeyDelete.parse_obj({
