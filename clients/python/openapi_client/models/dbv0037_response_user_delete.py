...
class Dbv0037ResponseUserDelete(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseUserDelete:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseUserDelete:
        """Create an instance of Dbv0037ResponseUserDelete from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseUserDelete.parse_obj(obj)

        _obj = Dbv0037ResponseUserDelete.parse_obj({
