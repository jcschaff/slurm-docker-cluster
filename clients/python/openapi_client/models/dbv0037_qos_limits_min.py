...
class Dbv0037QosLimitsMin(BaseModel):
    """
    Min limit settings  # noqa: E501
    """
    priority_threshold: Optional[StrictInt] = Field(None, description="Min priority threshold")
    tres: Optional[Dbv0037QosLimitsMinTres] = None
    __properties = ["priority_threshold", "tres"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037QosLimitsMin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037QosLimitsMin:
        """Create an instance of Dbv0037QosLimitsMin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037QosLimitsMin.parse_obj(obj)

        _obj = Dbv0037QosLimitsMin.parse_obj({
            "priority_threshold": obj.get("priority_threshold"),
            "tres": Dbv0037QosLimitsMinTres.from_dict(obj.get("tres")) if obj.get("tres") is not None else None
        })
        return _obj
