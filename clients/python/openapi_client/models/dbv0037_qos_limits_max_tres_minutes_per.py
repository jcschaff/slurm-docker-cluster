...
class Dbv0037QosLimitsMaxTresMinutesPer(BaseModel):
    """
    Max TRES minutes per settings  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037QosLimitsMaxTresMinutesPer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037QosLimitsMaxTresMinutesPer:
        """Create an instance of Dbv0037QosLimitsMaxTresMinutesPer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037QosLimitsMaxTresMinutesPer.parse_obj(obj)

        _obj = Dbv0037QosLimitsMaxTresMinutesPer.parse_obj({
