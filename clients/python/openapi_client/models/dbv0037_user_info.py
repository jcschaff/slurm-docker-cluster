...
class Dbv0037UserInfo(BaseModel):
    """
    Dbv0037UserInfo
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037UserInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037UserInfo:
        """Create an instance of Dbv0037UserInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037UserInfo.parse_obj(obj)

        _obj = Dbv0037UserInfo.parse_obj({
