...
class Dbv0037ResponseAccountDelete(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseAccountDelete:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseAccountDelete:
        """Create an instance of Dbv0037ResponseAccountDelete from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseAccountDelete.parse_obj(obj)

        _obj = Dbv0037ResponseAccountDelete.parse_obj({
