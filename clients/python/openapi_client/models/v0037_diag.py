...
class V0037Diag(BaseModel):
    """
    V0037Diag
    """
    errors: Optional[conlist(V0037Error)] = Field(None, description="slurm errors")
    statistics: Optional[V0037DiagStatistics] = None
    __properties = ["errors", "statistics"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V0037Diag:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V0037Diag:
        """Create an instance of V0037Diag from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V0037Diag.parse_obj(obj)

        _obj = V0037Diag.parse_obj({
            "errors": [V0037Error.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "statistics": V0037DiagStatistics.from_dict(obj.get("statistics")) if obj.get("statistics") is not None else None
        })
        return _obj
