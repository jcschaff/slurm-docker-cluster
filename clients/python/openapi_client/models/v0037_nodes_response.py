...
class V0037NodesResponse(BaseModel):
    """
    V0037NodesResponse
    """
    errors: Optional[conlist(V0037Error)] = Field(None, description="slurm errors")
    nodes: Optional[conlist(V0037Node)] = Field(None, description="nodes info")
    __properties = ["errors", "nodes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V0037NodesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V0037NodesResponse:
        """Create an instance of V0037NodesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V0037NodesResponse.parse_obj(obj)

        _obj = V0037NodesResponse.parse_obj({
            "errors": [V0037Error.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "nodes": [V0037Node.from_dict(_item) for _item in obj.get("nodes")] if obj.get("nodes") is not None else None
        })
        return _obj
