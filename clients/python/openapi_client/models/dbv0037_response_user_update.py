...
class Dbv0037ResponseUserUpdate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037ResponseUserUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037ResponseUserUpdate:
        """Create an instance of Dbv0037ResponseUserUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037ResponseUserUpdate.parse_obj(obj)

        _obj = Dbv0037ResponseUserUpdate.parse_obj({
