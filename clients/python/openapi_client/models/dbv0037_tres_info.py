...
class Dbv0037TresInfo(BaseModel):
    """
    Dbv0037TresInfo
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dbv0037TresInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dbv0037TresInfo:
        """Create an instance of Dbv0037TresInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dbv0037TresInfo.parse_obj(obj)

        _obj = Dbv0037TresInfo.parse_obj({
