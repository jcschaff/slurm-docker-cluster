...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("user", new ApiKeyAuth("header", "X-SLURM-USER-NAME"));
        authentications.put("token", new ApiKeyAuth("header", "X-SLURM-USER-TOKEN"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.0.37/java");
